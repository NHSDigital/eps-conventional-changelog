# EPS CONVENTIONAL CHANGELOG

[![Release to NPM](https://github.com/NHSDigital/eps-conventional-changelog/actions/workflows/release.yml/badge.svg?branch=main)](https://github.com/NHSDigital/eps-conventional-changelog/actions/workflows/release.yml)
[![Quality gate](https://sonarcloud.io/api/project_badges/quality_gate?project=NHSDigital_eps-conventional-changelog)](https://sonarcloud.io/summary/new_code?id=NHSDigital_eps-conventional-changelog)

This repository contains a customized version of conventional-changelog-eslint based off https://github.com/conventional-changelog/conventional-changelog/tree/master/packages/conventional-changelog-eslint

## Functionality

This repository creates an NPM package that is designed to be used as a release notes generator by [semantic-release](https://semantic-release.gitbook.io/semantic-release/)
...
```bash
npm install @nhs/eps-conventional-changelog
```

Then add the following to your .releaserc file
...
...
        [
            ...
            {
                "config": "conventional-changelog-eps"
            }
        ],
...
}
...
See a working example in <https://github.com/NHSDigital/nhs-fhir-middy-error-handler/blob/main/.releaserc>
...
You will need the "Execute Analysis" permission for the project (NHSDigital_eps-conventional-changelog) in order for the token to work.
...
- `release.yml`: Uses [semantic-release](https://semantic-release.gitbook.io/semantic-release/) to release main branch to [NPM](https://www.npmjs.com/package/@nhs/eps-conventional-changelog).
