...
import fs from "fs"
import {formatMessageArgs, createRandomCommitMessage} from "./commit"
import {createTmpDirectory} from "./tmp"
...
export class TestTools {
  ...
  gitInit() {
    ...
    this.exec("git config --global user.email test@test.com")
    this.exec("git config --global user.name test@test.com")
